(function(){var a=function(){var n=this;var w="tracker.marinsm.com";var G="yo1jcw1vv0";
var H=365;var y=[];var o=false;var d="";var F=5;var m=function(){var J=[];return J
};this.setClientId=function(J){G=J};this.activateAnonymizeIp=function(){o=true};var D=function(){return G
};this.setHost=function(J){w=J};var g=function(){return w};this.setExpires=function(J){H=J
};this.setDefaultSubDomain=function(J){d=J};var j=function(){var J=new Date();J.setTime(J.getTime()+(H*24*60*60*1000));
return"; expires="+J.toUTCString()};var C=function(){var J=new Date();return J.getTimezoneOffset()/60
};var c=function(J){return(typeof J==="function")||(!!J&&typeof J!="string"&&!J.nodeName&&J.constructor!=Array&&/^[\s[]?function/.test(J+""))
